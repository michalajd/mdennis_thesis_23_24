...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/sr_pq_s/sr_pq_s.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_pq_s_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sr_pq_s_wrapper.tcl -notrace
