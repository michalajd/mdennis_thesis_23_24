...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/sr_pq/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_pq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sr_pq_wrapper.tcl
