...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/ra_pq/ra_pq_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ra_pq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ra_pq_wrapper.tcl
