...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq/ra_pq_r/ra_pq_r_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ra_pq_r_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ra_pq_r_wrapper.tcl -notrace
